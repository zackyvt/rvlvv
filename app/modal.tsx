...
export default function ModalScreen(props: any) {
  ...
  useEffect(() => {AsyncStorage.getItem('notes').then((value) => {
  ...
  const handleChangeName = (event: any) => {
    ...
    setNote({id: (note! as any).id, category: note.category,
...
<RichToolbar
      ...
      /*<TextArea autoCompleteType={""} marginTop={2} flexGrow={1} 
      placeholder="Super secret government info..." 
      value={note ? (note as any).contents : null} onChange={handleChangeContents}/>*/
      }
      <Box padding="5">
